			...
			while True:
				try:
					...
					if beltelecom.status_code == 200:
						print("\033[32m\033[1m Beltelecom СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if bamboogroup.status_code == 200:
						print("\033[32m\033[1m Bamboogroup СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if rutube.status_code == 200:
						print("\033[32m\033[1m Rutube СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if ivi.status_code == 200:
						print("\033[32m\033[1m IVI СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if shopby.status_code == 200:
						print("\033[32m\033[1m Shop.by СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if icq.status_code == 200:
						print("\033[32m\033[1m ICQ СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if okru.status_code == 200:
						print("\033[32m\033[1m Ok.ru СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if youla.status_code == 200:
						print("\033[32m\033[1m Youla СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if yandex_eda.status_code == 200:
						print("\033[32m\033[1m Yandex Eda СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if tinkoff.status_code == 200:
						print("\033[32m\033[1m Tinkoff СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if utair.status_code == 200:
						print("\033[32m\033[1m Utair СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
				...
				try:
					...
					if tiktok.status_code == 200:
						print("\033[32m\033[1m TikTok СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]")
						nms += 1
					else:
